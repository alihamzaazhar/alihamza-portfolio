    ...
    <section id="projects" className="w-full">
      ...
      <div className="mt-12 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        {PROJECTS.map((project) => (
          <div key={project.title} className="border border-[var(--gray)]">
            <div className="aspect-video overflow-hidden border-b border-[var(--gray)]">
              <img alt={project.title} className="h-full w-full object-cover" loading="lazy" src={project.image} />
            </div>
